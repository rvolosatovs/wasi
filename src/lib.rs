...
mod command {
    wit_bindgen::generate!({
        ...
        with: {
            ...
            "wasi:cli/stdout@0.3.0": crate::cli::stdout,
            "wasi:cli/terminal-input@0.3.0": crate::cli::terminal_input,
            "wasi:cli/terminal-output@0.3.0": crate::cli::terminal_output,
            "wasi:cli/terminal-stderr@0.3.0": crate::cli::terminal_stderr,
            "wasi:cli/terminal-stdin@0.3.0": crate::cli::terminal_stdin,
            "wasi:cli/terminal-stdout@0.3.0": crate::cli::terminal_stdout,
            "wasi:clocks/monotonic-clock@0.3.0": crate::clocks::monotonic_clock,
            "wasi:clocks/wall-clock@0.3.0": crate::clocks::wall_clock,
            "wasi:filesystem/preopens@0.3.0": crate::filesystem::preopens,
            "wasi:filesystem/types@0.3.0": crate::filesystem::types,
            "wasi:random/insecure-seed@0.3.0": crate::random::insecure_seed,
            "wasi:random/insecure@0.3.0": crate::random::insecure,
            "wasi:random/random@0.3.0": crate::random::random,
            "wasi:sockets/ip-name-lookup@0.3.0": crate::sockets::ip_name_lookup,
            "wasi:sockets/types@0.3.0": crate::sockets::types,
        },
    });
}
#[allow(unused_imports)]
