...
mod bindings {
    wit_bindgen::generate!({
        path: "src/p3/wit",
        default_bindings_module: "wasi::p3",
        async: {
             imports: [
...
mod command {
    wit_bindgen::generate!({
        ...
        with: {
            "wasi:cli/environment@0.3.0": crate::p3::cli::environment,
            "wasi:cli/exit@0.3.0": crate::p3::cli::exit,
            "wasi:cli/stderr@0.3.0": crate::p3::cli::stderr,
            "wasi:cli/stdin@0.3.0": crate::p3::cli::stdin,
            "wasi:cli/stdout@0.3.0": crate::p3::cli::stdout,
            "wasi:cli/terminal-input@0.3.0": crate::p3::cli::terminal_input,
            "wasi:cli/terminal-output@0.3.0": crate::p3::cli::terminal_output,
            "wasi:cli/terminal-stderr@0.3.0": crate::p3::cli::terminal_stderr,
            "wasi:cli/terminal-stdin@0.3.0": crate::p3::cli::terminal_stdin,
            "wasi:cli/terminal-stdout@0.3.0": crate::p3::cli::terminal_stdout,
            "wasi:clocks/monotonic-clock@0.3.0": crate::p3::clocks::monotonic_clock,
            "wasi:clocks/wall-clock@0.3.0": crate::p3::clocks::wall_clock,
            "wasi:filesystem/preopens@0.3.0": crate::p3::filesystem::preopens,
            "wasi:filesystem/types@0.3.0": crate::p3::filesystem::types,
            "wasi:random/insecure-seed@0.3.0": crate::p3::random::insecure_seed,
            "wasi:random/insecure@0.3.0": crate::p3::random::insecure,
            "wasi:random/random@0.3.0": crate::p3::random::random,
            "wasi:sockets/ip-name-lookup@0.3.0": crate::p3::sockets::ip_name_lookup,
            "wasi:sockets/types@0.3.0": crate::p3::sockets::types,
        },
    });
}
#[allow(unused_imports)]
